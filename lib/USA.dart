...
class UsaClima extends StatefulWidget {
  UsaClima({Key? key}) : super(key: key);

  @override
  State<UsaClima> createState() => _MexClimaState();
}

class _MexClimaState extends State<UsaClima> {
      ...
      body: Container(
        child: SafeArea(
          child: Column(children: [
            const Text('USA:', style: TextStyle(fontSize: 30),),
            Padding(
