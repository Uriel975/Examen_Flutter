...
class GerClima extends StatefulWidget {
  GerClima({Key? key}) : super(key: key);

  @override
  State<GerClima> createState() => _MexClimaState();
}

class _MexClimaState extends State<GerClima> {
      ...
      body: Container(
        child: SafeArea(
          child: Column(children: [
            const Text('Alemania:', style: TextStyle(fontSize: 30),),
            Padding(
