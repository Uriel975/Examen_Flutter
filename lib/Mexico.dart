...
class MexClima extends StatefulWidget {
  MexClima({Key? key}) : super(key: key);

  @override
  State<MexClima> createState() => _MexClimaState();
}

class _MexClimaState extends State<MexClima> {
      ...
      body: Container(
        child: SafeArea(
          child: Column(children: [
            const Text('Mexico:', style: TextStyle(fontSize: 30),),
            Padding(
