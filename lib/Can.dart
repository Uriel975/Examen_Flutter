...
class CanClima extends StatefulWidget {
  CanClima({Key? key}) : super(key: key);

  @override
  State<CanClima> createState() => _MexClimaState();
}

class _MexClimaState extends State<CanClima> {
      ...
      body: Container(
        child: SafeArea(
          child: Column(children: [
            const Text('Canada:', style: TextStyle(fontSize: 30),),
            Padding(
